...
public class AdapterForProduct extends RecyclerView.Adapter<AdapterForProduct.MyViewHolder> {
    ...
    public AdapterForProduct(List<PojoProduct> list, Context context, OnCartCountChangeListener listener) {
        this.list = list;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        String productId, Imageurl, productName, productPrice, OffPrice;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view, db, cartCountChangeListener);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterForProduct.MyViewHolder holder, int position) {
        PojoProduct dto = list.get(position);
